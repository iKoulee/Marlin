...
#define STRING_CONFIG_H_AUTHOR "(Jakub Prokes, Anet config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet A8 based 3D printer"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, 42, -1.42 }
